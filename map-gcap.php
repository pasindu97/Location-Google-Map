		...
		function myMap() {
			...
			function userMarker(){
				for (var i = locUsers.length - 1; i >= 0; i--) {
                    ...
                    '<div class="iw-content">' +
                      '<p">'+locUsers[i][4]+'</p><img src="Icon/Photo-icon.png" alt ="location" height="120"/><br><center><form action="php/confirm_marker.php" method="post"><table><tr><td><input type="hidden" value = "'+parseInt(locUsers[i][0])+'" name="ID"></td></tr><tr><td><button id="btnsub" name="submit2" class="btn btn-success" >ACCEPT</button></td><td><button id="cancel" name="dec" class="btn btn-danger" >DECLINE</button></td></tr></table></form></center>'+'</div>');
