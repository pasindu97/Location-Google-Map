...
<body>
	...
	<nav class="navBar  " style="position: relative;">
		...
		<div id="login"><a href="Login/login.php"><ion-icon name="contacts"></ion-icon> -- Login Here</a></div><a id ="logright" name="logout" href="home.php?logout=1"></a> 
		</div>
	</nav>
	...
	<div clss="container">
		...
		<div align="center">
			...
			<form action="php/post_marker_u.php" method="post" style="display: none">
				<table>
